    ...
    <>
      ...
      <div className="w-full rounded-md overflow-x-auto p-2 hide-scroll-bar" ref={scrollRef}>
        <div className="flex w-max space-x-4 p-2" style={{ scrollBehavior: "smooth" }}>
          {devices.map((device) => (
            <div key={device.id} className="bg-dark-3 flex-col p-3 rounded-xl border-dark-4 border-[1px] hover:scale-105  active:scale-100 transition-all duration-200" onClick={() => handleCardClick(device.id)}>
              ...
              <div className="flex justify-between items-center mt-23">
                <div className="flex gap-2">
                  ...
                  onClick={(e) => e.stopPropagation()}>Connect</Button>
                  }
